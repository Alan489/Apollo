...
namespace Apollo2.Server.Controllers.Sys.Unit
{
 [ApiController]
 [Route("API/Sys/Unit/[controller]")]
 public class LoginController : Controller
 {

  private UnitUserDBContext _udbc;

  public LoginController(UnitUserDBContext udbc) 
  { 
   _udbc = udbc;
  }
